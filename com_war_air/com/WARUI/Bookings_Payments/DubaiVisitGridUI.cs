...
{
    public partial class DubaiVisitGridUI : WarFramework.Forms.WarForm
    {
        public DubaiVisitGridUI()
        {
            InitializeComponent();
        }
        ...
        {
            WarGrid1.DataSource = WARPRO.Glob.CustomersAndAgents.Glob_DubaiVisit.Get_DubaiVisit_Table_DataFOrGrid(VisaNo_Txt.Text, CustomerID_Txt.Text);
        ...
        internal void Cellcliick()
        {
            ...
            else
            {
                ...
                DubaiVisitUI bk = new DubaiVisitUI(ss);
                bk.ShowDialog();
